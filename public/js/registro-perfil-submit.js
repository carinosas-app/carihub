(function (global) {
  ...
  function buildUsuarioDoc(uid, draft, priv, publicUrls, opts) {
    ...
    var doc = {
      ...
      edecanPerfil: mappedBloques.edecanPerfil ? Object.assign({}, mappedBloques.edecanPerfil) : null,
      modelosPerfil: mappedBloques.modelosPerfil ? Object.assign({}, mappedBloques.modelosPerfil) : null,
      ...
      rolInteraccion: mappedBloques.rolInteraccion || '',
      ...
      tiposEvento: mappedBloques.tiposEvento || [],
      tiposModelaje: mappedBloques.tiposModelaje || [],
      modalidadFicha: mappedBloques.modalidadFicha || '',
      ...
      atiendoA: mappedBloques.atiendoA || '',
      mostrarAtiendoA: mappedBloques.mostrarAtiendoA || 'Sí',
      haceColaboraciones: mappedBloques.haceColaboraciones || '',
      colaboraCon: mappedBloques.colaboraCon || [],
      mostrarColaboraciones: mappedBloques.mostrarColaboraciones || 'Sí',
      estiloLesbian: mappedBloques.estiloLesbian || '',
