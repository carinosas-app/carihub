(function(){
  const CATEGORIAS=[
    ...
    {id:"escort gay",nombre:"Escort Gay",emoji:"🏳️‍🌈",label:"🏳️‍🌈 Escort Gay"},
    ...
    {id:"sex shop",nombre:"Sex Shop",emoji:"🛍️",label:"🛍️ Sex Shop"},
    ...
    {id:"trans",nombre:"Trans",emoji:"⚧️",label:"⚧️ Trans"},
    ...
    {id:"lesbians",nombre:"Lesbians",emoji:"👩‍❤️‍👩",label:"👩‍❤️‍👩 Lesbians"},
    ...
    {id:"sado",nombre:"Sado",emoji:"⛓️",label:"⛓️ Sado"},
