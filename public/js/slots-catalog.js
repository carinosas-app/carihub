...
(function (global) {
  ...
  var SLOTS = {
    ...
    home_estados: { capacidadMaxima: 5, mvpCore: true, tier: 'standard', activo: true },
    home_libe: { capacidadMaxima: 3, mvpCore: true, tier: 'standard', activo: true },
    ...
    sin_resultados_estados: { capacidadMaxima: 5, mvpCore: true, tier: 'standard', activo: true },
    sin_resultados_libe: { capacidadMaxima: 3, mvpCore: true, tier: 'standard', activo: true },
    ...
    resultados_estados: { capacidadMaxima: 5, mvpCore: true, tier: 'standard', activo: true },
    resultados_libe: { capacidadMaxima: 3, mvpCore: true, tier: 'standard', activo: true },
    resultados_pais_izquierda: { capacidadMaxima: 3, mvpCore: false, tier: 'standard', activo: true },
    resultados_pais_centro: { capacidadMaxima: 2, mvpCore: false, tier: 'standard', activo: true },
    resultados_pais_derecha: { capacidadMaxima: 3, mvpCore: false, tier: 'standard', activo: true },
    resultados_pais_inferior: { capacidadMaxima: 3, mvpCore: false, tier: 'standard', activo: true },
    resultados_pais_estados: { capacidadMaxima: 5, mvpCore: false, tier: 'standard', activo: true },
    resultados_pais_libe: { capacidadMaxima: 3, mvpCore: false, tier: 'standard', activo: true },
    resultados_estado_izquierda: { capacidadMaxima: 3, mvpCore: false, tier: 'standard', activo: true },
    resultados_estado_centro: { capacidadMaxima: 2, mvpCore: false, tier: 'standard', activo: true },
    resultados_estado_derecha: { capacidadMaxima: 3, mvpCore: false, tier: 'standard', activo: true },
    resultados_estado_inferior: { capacidadMaxima: 3, mvpCore: false, tier: 'standard', activo: true },
    resultados_estado_estados: { capacidadMaxima: 5, mvpCore: false, tier: 'standard', activo: true },
    resultados_estado_libe: { capacidadMaxima: 3, mvpCore: false, tier: 'standard', activo: true },
    ...
    perfil_estados: { capacidadMaxima: 5, mvpCore: true, tier: 'standard', activo: true },
    perfil_libe: { capacidadMaxima: 3, mvpCore: true, tier: 'standard', activo: true },
