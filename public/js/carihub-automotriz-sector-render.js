...
(function (global) {
  ...
  function buildDatosRows(canonId, p, u) {
    ...
    if (p.diferenciadorAutomotriz) pushRow(rows, 'car', 'Tu sello', p.diferenciadorAutomotriz);
    ...
    if (p.coberturaCarretera) pushRow(rows, 'globe', 'Carretera', p.coberturaCarretera);
    return rows;
  }
