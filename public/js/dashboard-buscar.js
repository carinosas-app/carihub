...
(function (global) {
  ...
  var MOCK_DIRECTORIO = [
    ...
    { id: "mock-andrea", nombre: "Andrea VIP", categoria: "Cariñosas VIP", pais: "México", estado: "Nuevo León", ciudad: "Monterrey", verificado: true, img: "https://images.unsplash.com/photo-1509967419530-da38b4704bc6?w=320&q=80", tagline: "VIP Monterrey", precio: "3,500", url: "perfil-publico.html?preview=1" },
    { id: "mock-luna", nombre: "Luna M.", categoria: "Cariñosas", pais: "México", estado: "Nuevo León", ciudad: "San Pedro", verificado: true, img: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=320&q=80", tagline: "San Pedro · Eventos", precio: "2,000", url: "perfil-publico.html?preview=1" },
    ...
    { id: "mock-valentina", nombre: "Valentina", categoria: "Cariñosas VIP", pais: "México", estado: "Nuevo León", ciudad: "Monterrey", verificado: true, img: "https://images.unsplash.com/photo-1512310604669-443f26c35f52?w=320&q=80", tagline: "Monterrey centro", precio: "4,000", url: "perfil-publico.html?preview=1" },
  ];
