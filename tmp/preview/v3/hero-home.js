(function () {
  ...
  var U = {
    promo: 'assets/user/hero-carinosa-motel-spa-runway.png',
    promoPerfil: 'assets/user/hero-carinosa-motel-spa-runway.png',
    lgbt: 'assets/user/hero-escort-gay.png',
    lesbianas: 'assets/user/hero-lesbianas.png',
    lounge: 'assets/user/hero-club-swinger.png',
    motelSpa: 'assets/user/hero-motel-spa-fachada.png',
    motel: 'assets/user/hero-motel-noche-rojo.png',
    spa: 'assets/user/hero-spa-interior.png',
    sexshop: 'assets/user/hero-negocios-grid-noche.png',
    nightclub: 'assets/user/hero-bar-neon.png',
    antro: 'assets/user/hero-antro-restaurante.png',
    negocios: 'assets/user/hero-calle-negocios-dia.png',
    grid: 'assets/user/hero-negocios-grid-noche.png'
  };
  ...
  window.CARIHUB_HERO_SLIDES = buildHeroSlides(window.CARIHUB_CATEGORIAS_HOME || []);
})();
